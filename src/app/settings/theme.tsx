    ...
    return (
        <Box flex={1} backgroundColor="background" padding="medium">
            <Box flexDirection="row" alignItems="center" marginTop="xl" marginBottom="large">
                ...
                <Text variant="heading2" marginLeft="medium">Theme</Text>
            </Box>
            <Box flex={1} justifyContent="center" alignItems="center" opacity={0.5}>
                <Ionicons name="color-palette-outline" size={80} color="gray" />
                <Text variant="body" marginTop="medium">Theme customization coming soon!</Text>
            </Box>
        </Box>
    );
}
