    ...
    return (
        <Box flex={1} backgroundColor="background" padding="medium">
            <Box flexDirection="row" alignItems="center" marginTop="xl" marginBottom="large">
                ...
                <Text variant="heading2" marginLeft="medium">Notifications</Text>
            </Box>
            <Box flex={1} justifyContent="center" alignItems="center" opacity={0.5}>
                <Ionicons name="notifications-outline" size={80} color="gray" />
                <Text variant="body" marginTop="medium">Notification preferences coming soon!</Text>
            </Box>
        </Box>
    );
}
